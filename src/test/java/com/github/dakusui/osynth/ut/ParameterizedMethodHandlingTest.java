...
public class ParameterizedMethodHandlingTest extends UtBase {
  ...
  public void testSingle() {
    Single x = new CompatObjectSynthesizer().addInterface(Single.class).synthesize(Single.class);
    assertThat(
  ...
  public void testSingle_2() {
    Single x = new CompatObjectSynthesizer()
  ...
  public void testDouble() {
    Multi x = new CompatObjectSynthesizer().addInterface(Multi.class).synthesize(Multi.class);
    assertThat(
