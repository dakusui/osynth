...
public interface MethodHandlerEntry {
   ...
   */
  static MethodHandlerEntry equalsHandler(Object o, Function<Object, Object> converter) {
    return ObjectSynthesizer.methodCall("equals", Object.class)
        .with((self, args) -> o == args[0] || o.equals(converter.apply(args[0])));
  }

  static MethodHandlerEntry hashCodeHandler(Object o) {
    return hashCodeHandler(o, Object::hashCode);
  }

  static MethodHandlerEntry hashCodeHandler(Object o, Function<Object, Integer> hashCode) {
    return ObjectSynthesizer.methodCall("hashCode").with((self, args) -> hashCode.apply(o));
  }

  static MethodHandlerEntry toStringHandler(Object o, Function<Object, String> formatter) {
  ...
  class Builder {
    ...
    private       BiFunction<SynthesizedObject, Object[], Object> function;

    public Builder(Predicate<Method> matcher) {
      this.matcher = Objects.requireNonNull(matcher);
    }

    public MethodHandlerEntry with(BiFunction<SynthesizedObject, Object[], Object> function) {
    ...
    public MethodHandlerEntry build() {
      return new MethodHandlerEntry() {
        ...
        @Override
        public MethodHandler function() {
          return (o, args) -> function.apply(o, args);
        }
